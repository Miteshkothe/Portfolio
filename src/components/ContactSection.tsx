    ...
    <div className="max-w-[700px] mx-auto text-center relative z-10">
      ...
      <motion.div
        ...
        {[
          ...
          { label: "Download CV", href: "https://drive.google.com/file/d/1wgXXwbGxmmjrMlEyZ84WW0HNErDWJI7n/view?usp=sharing", icon: "M19 9h-4V3H9v6H5l7 7 7-7zM5 18v2h14v-2H5z" },
        ].map((c) => (
